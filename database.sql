...
--
-- Host: 127.0.0.1
-- Czas generowania: 02 Maj 2024, 16:41
...
CREATE TABLE `posts` (
  ...
  `post_as_comment` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `posts` (`post_id`, `author`, `author_firm`, `content`, `likes`, `shares`, `comments_number`, `file_id`, `post_as_comment`) VALUES
(4, 1, NULL, 'jhdfgjdfgjfd', 0, 0, 0, '66339a04c608c', NULL),
(5, 1, NULL, 'dfsadsadsadsadas', 0, 0, 0, '6633a35b8458d1.00942415', NULL);
...
ALTER TABLE `posts`
  ...
  ADD KEY `posts_fk8` (`post_as_comment`);
...
--
ALTER TABLE `user_account`
  MODIFY `user_ac_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
